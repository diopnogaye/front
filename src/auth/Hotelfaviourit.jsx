    ...
    <div>
       <header className='header'>
         ...
         <div className="jumbos">
            <div className="jum">
         <img src="./src/assets/Group.png " alt="" className='image'/>
                <div className="rows">
                <h1>Radisson Blu</h1>
                <div className='champs-texte1'>
                            ...
                            <label htmlFor="">La Kalsa, Palermo</label>
                           </div>
                        </div>
                  <div className='champs-texte1'>
                            <div className='champs'>
                                <label htmlFor="">$ 140</label> <br />
                            </div>
                            <div className='champs2'>
                            <label htmlFor="">16% Off</label>
                           </div>
                        </div>
                  ...
                  <div className='champs-texte111'>
                    ...
                    <div className="jum">
         <img src="./src/assets/Group1.png " alt="" className='image'/>
                <div className="rows">
                <h1>Radisson Blu</h1>
                <div className='champs-texte1'>
                            <div className='champs'>
                  ...
                  <div className='champs-texte1'>
                            <div className='champs'>
                                <label htmlFor="">$ 135</label> <br />
                            </div>
                            <div className='champs2'>
                            <label htmlFor="">12% Off</label>
                           </div>
                        </div>
                        <p>Includes Taxes And Charges</p>
                   <div className='champs-texte1'>
                  ...
                  <div className='champs-texte111'>
                    ...
                    <div className="jum">
         <img src="./src/assets/Group2.png " alt="" className='image'/>
                <div className="rows">
                <h1>Radisson Blu</h1>
                <div className='champs-texte1'>
                            <div className='champs'>
                  ...
                  <div className='champs-texte111'>
                    ...
                    <div className="jumboss">
                    <div className="jum">
         <img src="./src/assets/Group3.png " alt="" className='image'/>
                <div className="rows">
                <h1>Radisson Blu</h1>
                <div className='champs-texte1'>
                            <div className='champs'>
                  ...
                  <div className='champs-texte111'>
                    ...
                    <div className="jum">
         <img src="./src/assets/Group4.png " alt="" className='image'/>
                <div className="rows">
                <h1>Radisson Blu</h1>
                <div className='champs-texte1'>
                            <div className='champs'>
